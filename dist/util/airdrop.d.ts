...
export declare const calculateAirdropReward: (trs: TransactionSchema<AssetStakeSchema | AssetVoteSchema>, amount: number, sender: Account, lastBlockHeight: number, availableAirdropBalance: number, availableARPBalance?: number) => AirdropReward;
